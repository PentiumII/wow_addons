...
do
   if (GetLocale() == "zhTW") then
      Gladius.L = setmetatable({
	      -- March 20 2013 added by Cyanc - NGA ---
	  	 ["Announcements"] = "通知",
		 ["CastBar"] = "施法條",
		 ["ClassIcon"] = "職業圖示",
		 ["Clicks"] = "點擊執行",
		 ...
		 ["Timer"] = "計時器",		 
		 ["Direction"] = "框架擴展方向",  
		 ["The Direction you want the frame to go in."] = "設置你想要框架擴展的方向",
		 ["Up"] = "上", 
		 ["Down"] = "下",		 
		 ["Left"] = "左", 
		 ["Right"] = "右", 	 
		 ["Announces when an enemy cast a dispell."] = "當一個敵對玩家施放驅散技能時發出通知", 
		 ["Dispell Grid Style Icon"] = "Grid風格圖示", 
		 ["Dispell Grid Style Icon Color"] = "Grid風格驅散圖示顔色", 
		 ["Dispell Grid Style Icon Used Color"] = "Grid風格驅散圖示已使用顔色", 
		 ["Dispell Cooldown Spiral"] = "驅散冷卻計時",
		 ["Dispell Cooldown Reverse"] = "驅散冷卻反轉",
		 ["Dispell Gloss"] = "覆蓋驅散框架",
		 ["Dispell Gloss Color"] = "覆蓋驅散框架顔色",
		 ["Dispell Icon Border Crop"] = "驅散圖標邊框", 
		 ["Dispell Icon Faction"] = "陣營驅散圖示",
		 ["Toggle if the dispell icon should be changing based on the opponents faction"] = "若要切換飾品圖標需在對方陣營的基礎上變更才行",
		 ["Dispell Frame Level"] = "驅散框架層級",
		 ["Frame level of the dispell"] = "驅散框的架層級",
		 ["Dispell Adjust Size"] = "驅散框架 調整大小", 	 
		 ["Dispell Size"] = "驅散框架 大小值", 	 
		 ["Dispell Attach To"] = "驅散框架附加到", 	 
		 ["Attach dispell to the given frame"] = "附加驅散框架到指定的框體", 
		 ["Dispell Position"] = "驅散框架位置", 	
		 ["Dispell Anchor"] = "驅散框架錨點",
		 ["Dispell Relative Point"] = "驅散框架相對定位",
	     ----------------------------------------------------------
         ["Frame"] = "框體",
         ...
         ["Global Templates"] = "整體樣板",
         ["Global templates"] = "整體的樣板",
         ["Arms"] = "武器",
         ["Fury"] = "狂怒",
         ["Protection"] = "防護",
         ["Holy"] = "神聖",
		 ...
		 ["Announcements"] = "通告",            
         ["Announcements settings"] = "通告設定",
         ["CastBar"] = "施法條",
         ["CastBar settings"] = "施法條設定",
         ["ClassIcon"] = "職業圖示",
         ["ClassIcon settings"] = "職業圖示設定",
         ["Clicks"] = "點擊",
         ["Clicks settings"] = "點擊設定",
         ["DRTracker"] = "控場追蹤",
         ["DRTracker settings"] = "控場追蹤設定",
         ["HealthBar"] = "生命條",      
         ["HealthBar settings"] = "生命條設定",
         ["Highlight"] = "高亮",         
         ["Highlight settings"] = "高亮設定",
         ["Layout"] = "編排",
         ["Layout settings"] = "編排設定",
         ["PowerBar"] = "動能條",   
         ["PowerBar settings"] = "動能條設定",
         ["TargetBar"] = "目標條",
         ["TargetBar settings"] = "目標條設定",      
         ["Timer"] = "計時條",                  
         ["Timer settings"] = "計時條設定",
         ["Layout Code"] = "編排代碼",
         ...
         ["Y offset of the power bar"] = "動能條的位移 Y",
         ["Power colors"] = "動能顏色",
         ...
         ["Default Power Energy Color"] = "預設的能量顏色",
         ["Toggle default power energy color"] = "切換預設的能量顏色",
         ["Power Energy Color"] = "能量顏色",
