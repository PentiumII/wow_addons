...
do
   if (GetLocale() == "zhCN") then
      Gladius.L = setmetatable({
		 ...
		 ["Dispell"] = "驱散监视",
		 ["Dispell settings"] = "Dispell设置选项",
		 ["Direction"] = "框架扩展方向",  
		 ["The Direction you want the frame to go in."] = "设置你想要框架扩展的方向",
		 ["Up"] = "上", 
		 ["Down"] = "下",		 
		 ["Left"] = "左", 
		 ["Right"] = "右", 	 
		 ["Announces when an enemy cast a dispell."] = "当一个敌对玩家施放驱散技能时发出通知", 
		 ["Dispell Grid Style Icon"] = "Grid风格图示", 
		 ["Dispell Grid Style Icon Color"] = "Grid风格驱散图示颜色", 
		 ["Dispell Grid Style Icon Used Color"] = "Grid风格驱散图示已使用颜色", 
		 ["Dispell Cooldown Spiral"] = "驱散冷却计时",
		 ["Dispell Cooldown Reverse"] = "驱散冷却反转",
		 ["Dispell Gloss"] = "覆盖驱散框架",
		 ["Dispell Gloss Color"] = "覆盖驱散框架颜色",
		 ["Dispell Icon Border Crop"] = "驱散图标边框", 
		 ["Dispell Icon Faction"] = "阵营驱散图示",
		 ["Toggle if the dispell icon should be changing based on the opponents faction"] = "若要切换饰品图标需在对方阵营的基础上变更才行",
		 ["Dispell Frame Level"] = "驱散框架层级",
		 ["Frame level of the dispell"] = "驱散框的架层级",
		 ["Dispell Adjust Size"] = "驱散框架 调整大小", 	 
		 ["Dispell Size"] = "驱散框架 大小值", 	 
		 ["Dispell Attach To"] = "驱散框架附加到", 	 
		 ["Attach dispell to the given frame"] = "附加驱散框架到指定的框体", 
		 ["Dispell Position"] = "驱散框架位置", 	
		 ["Dispell Anchor"] = "驱散框架锚点",
		 ["Dispell Relative Point"] = "驱散框架相对定位",
		 ["Dispell Offset X"] = "驱散框架位移 X", 	 
		 ["Dispell Offset Y"] = "驱散框架位移 Y", 	 
		 --------------------------------------
