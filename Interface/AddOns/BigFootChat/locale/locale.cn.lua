...
L["You entered contains sensitive words"]=" 您所输入内容包含敏感词,为维护频道和谐我们对其进行屏蔽,谢谢您的合作~"
L["Kindly Reminder"]={"【大脚温馨提示】：大脚世界频道管理员为系统随机生成，并非178工作人员切勿轻信。",}
L["RollDice"] = "掷骰子"
L["Report"] = "个人属性通报"
L["Raiders"] = "大脚一句话攻略"
...
if GetLocale()=="zhCN" then
	...
	StatReport_Strings_CRDEF		= "PvP韧性";
	StatReport_Strings_CRPP			= "PvP强度";
	StatReport_Strings_NONE			= "无";
	StatReport_Strings_ILVL			= "(当前)装备等级";
