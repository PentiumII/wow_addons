...
local function ChatFrame_OnHyperlinkEnter(self, linkData, link)
	...
	if strfind(linkData,"^item") or strfind(linkData,"^enchant") or strfind(linkData,"^quest") or strfind(linkData,"^instancelock") or strfind(linkData,"^achievement") or strfind(linkData,"^talent") --[[or strfind(linkData,"^battlepet")]] or strfind(linkData,"^spell") then
