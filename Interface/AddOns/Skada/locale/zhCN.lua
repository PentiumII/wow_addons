...
L["Aggressive combat detection"] = "战斗检测"
L["All data has been reset."] = "所有数据已被重置"
L["All Skada functionality is now in 1 addon folder."] = "现在Skada的所有功能都在同一个文件夹中" -- Needs review
L["Alternate color"] = "交替颜色"
L["Announce CC breaking to party"] = "当控场技能被打破时在小队中通报"
L["Appearance"] = "外观"
L["Ask"] = "询问"
L["Attack"] = "攻击"
...
L["Choose the default color of the bars."] = "选择计量条默认的颜色"
...
L["Class icons"] = "职业图标"
L["Click below and configure your '|cFFFF0000Disabled Modules|r'."] = "点击确定并配置你的 '|cFFFF0000禁用模块|r'." -- Needs review
L["Click for"] = "点击后为"
L["Clickthrough"] = "点击到底"
L["Columns"] = "列"
L["Combat mode"] = "战斗模式"
...
L["Damage taken"] = "受到伤害"
L["DamageTaken"] = "承受伤害" -- Needs review
...
L["Detailed"] = "详情"
L["Disable"] = "禁用"
L["Disabled Modules"] = "禁用模块" -- Needs review
...
L["Dodge"] = "躲闪"
L["Do not show DPS"] = "不显示每秒伤害"
L["Do not show HPS"] = "不显示每秒治疗"
L["Do not show TPS"] = "不显示每秒威胁值"
L["Do not warn while tanking"] = "坦克时不警报"
L["Do you want to reset Skada?"] = "你是否想重置Skada?"
L["DPS"] = "每秒伤害"
L["DTPS"] = "每秒承受伤害"
L["Enable"] = "启用"
L["Enables the title bar."] = "启用标题栏."
L["Enemies"] = "敌方相关" -- Needs review
L["Enemy damage done"] = "敌对伤害"
L["Enemy damage taken"] = "敌对受到伤害"
L["Enemy healing done"] = "敌方治疗"
L["Enemy healing taken"] = "敌方受到的治疗"
...
L["Immune"] = "免疫"
L["Include set"] = "包含设置" -- Needs review
L["Include set name in title bar"] = "标题栏包含设置名" -- Needs review
...
L["Maximum hit:"] = "最大伤害:"
L["Merge pets"] = "合并宠物"
L["Merges pets with their owners. Changing this only affects new data."] = "合并宠物及主人的数据.该设置仅会在设置后的统计中生效。"
L["Minimum hit:"] = "最小伤害:"
L["Missed"] = "未命中"
L["Mode"] = "模式"
...
L["Sets the scale of the window."] = "设置窗体的缩放"
L["'s Fails"] = "的失误"
L["Shake screen"] = "震动屏幕"
L["'s Healing"] = "的治疗"
...
L["Skada has changed!"] = "Skada已改版！" -- Needs review
L["Skada Menu"] = "Skada菜单"
L["Skada: Modes"] = "Skada: 模式"
L["Skada: %s for %s:"] = "Skada报告%s的%s:" -- Needs review
L["Skada summary"] = "Skada总揽"
L["Skada usually uses a very conservative (simple) combat detection scheme that works best in raids. With this option Skada attempts to emulate other damage meters. Useful for running dungeons. Meaningless on boss encounters."] = "当玩家进入战斗时开始统计，而不是玩家在进入战斗并造成伤害或治疗时再开始统计。"
L["Skada will |cFFFF0000NOT|r function properly until you delete the following AddOns:"] = "在你删除以下插件之前，Skada|cFFFF0000不会|r 正常运作：" -- Needs review
...
L["Thick outline"] = "粗体"
L["This change requires a UI reload. Are you sure?"] = "这个改变需要重载界面. 你确定吗?" -- Needs review
...
L["Tick the modules you want to disable."] = "勾选你想要禁用的模块" -- Needs review
L["Title bar"] = "标题栏"
L["Title height"] = "标题高度"
...
L["TotalHealing"] = "总体治疗" -- Needs review
L["TPS"] = "每秒仇恨"
L["Use class icons where applicable."] = "如果可行使用职业图标"
...
L["Multistrike"] = "Multistrike"
	...
	L["Healing and Absorbs spell list"] = "治疗和吸收法术列表"
	L["Healed and Absorbed players"] = "治疗和吸收角色"
	L["'s Healing & Absorbs"] = "的治疗和吸收"
