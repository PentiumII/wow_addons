...
L["Ask"] = "詢問"
L["Attack"] = "近戰攻擊"
L["Automatically switch to set 'Current' and this mode after a wipe."] = "清除後，自動切換至'當前的'模組。"
...
L["Sets the scale of the window."] = "設定視窗縮放。"
L["'s Fails"] = "的失誤"
L["Shake screen"] = "螢幕震動"
L["'s Healing"] = "的治療"
...
L["Shows a extra row with a summary in certain modes."] = "在某些模式的總結顯示一個額外的行。"
