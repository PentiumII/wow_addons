...
function mod:Create(window)
	...
	if window.bargroup then
		...
		-- Add window buttons.
		window.bargroup:AddButton(L["Close"], "Interface\\Buttons\\UI-Panel-MinimizeButton-Up.blp", "Interface\\Buttons\\UI-Panel-MinimizeButton-Up.blp", function() window:Hide() end)		--添加关闭按钮	bf@178.com
