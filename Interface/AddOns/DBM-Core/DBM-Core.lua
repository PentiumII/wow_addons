...
do
	...
	syncHandlers["PT"] = function(sender, timer, lastMapID)
		...
		if not DBM.Options.DontPlayPTCountdown then
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfive.ogg", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfour.ogg", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg", "Master")
			DBM:Unschedule(PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\com_go.ogg", "Master")
		...
		if not DBM.Options.DontPlayPTCountdown then
			...
			if timer > 5 then DBM:Schedule(timer-5, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfive.ogg", "Master") end
			if timer > 5 then DBM:Schedule(timer-4, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countfour.ogg", "Master") end
			if timer > 3 then DBM:Schedule(timer-3, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countthree.ogg", "Master") end
			if timer > 3 then DBM:Schedule(timer-2, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\counttwo.ogg", "Master") end
			if timer > 3 then DBM:Schedule(timer-1, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\countone.ogg", "Master") end
			if timer > 1 then DBM:Schedule(timer, PlaySoundFile, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\com_go.ogg", "Master") end
			...
			-- if version > tonumber(DBM.Version) then -- Update reminder
				...
				-- if #newerVersionPerson < 4 then
					...
					-- elseif #newerVersionPerson == 3 then--Requires 3 for force disable.
						...
						-- if revDifference > 280 then--WTF? Sorry but your DBM is being turned off until you update. Grossly out of date mods cause fps loss, freezes, lua error spam, or just very bad information, if mod is not up to date with latest changes. All around undesirable experience to put yourself or other raid mates through
...
--[[		local voice = DBM.Options.CountdownVoice
			...
			for i = count, 1, -1 do
				...
				if i <= 11 then
					self.sound5:Schedule(timer-i, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\"..countvaluei..".ogg")
				end
			end
		end
	end
