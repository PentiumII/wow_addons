...
function InfoBoxConfigFunc()
	...
	function BigFoot_SaveUIFrames()
		...
		---- save other frames' locations
	end

	function BigFoot_ResetUIFrames()
		PartyMemberFrame1:SetPoint("TOPLEFT",UIParent,"TOPLEFT",10,-138)

		PartyMemberFrame2:SetPoint("TOPLEFT",PartyMemberFrame1,"TOPLEFT",0,-57)

		PartyMemberFrame3:SetPoint("TOPLEFT",PartyMemberFrame2,"TOPLEFT",0,-57)

		PartyMemberFrame4:SetPoint("TOPLEFT",PartyMemberFrame3,"TOPLEFT",0,-57)
