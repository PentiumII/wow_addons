...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 394 $"):match("%d+"))
...
elseif GAME_LOCALE == "frFR" then
	...
	["Blade Lord Ta'yak"] = "Seigneur des lames Ta’yak", -- Needs review
	...
	Felmyst = "Gangrebrume",
	Feludius = "Feludius",
	["Feng the Accursed"] = "Feng le Maudit", -- Needs review
	...
	["Gara'jal the Spiritbinder"] = "Gara’jal le Lieur d’esprit", -- Needs review
	...
	["The Spirit Kings"] = "Les Esprits Rois", -- Needs review
	["The Stone Guard"] = "Le Garde de Pierre", -- Needs review
