...
function GridClickSetsFrame_OnEvent(self, event, addon)
	if(event=="PLAYER_REGEN_ENABLED") then
		if(queue) then
			GridClickSetsFrame_UpdateAll()
			queue = false
		end
	elseif((event=="ADDON_LOADED" and addon == "GridClickSets") or event=="ACTIVE_TALENT_GROUP_CHANGED" or event=="PLAYER_ALIVE") then
