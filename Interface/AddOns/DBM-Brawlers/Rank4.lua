...
function mod:SPELL_CAST_START(args)
	...
	if args.spellId == 134743 then
		sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\mobsoon.ogg")
		warnEarthSeed:Show()
...
function mod:SPELL_AURA_APPLIED(args)
	...
	if args.spellId == 129888 and self:AntiSpam() then
		...
		if mod:IsManaUser() then
			sndWOP:Play("Interface\\AddOns\\DBM-Sound-Yike\\yike\\runaway.ogg")
		end	elseif args.spellId == 133129 then
