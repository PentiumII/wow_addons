...
function mod:SPELL_CAST_START(args)
	if args.spellId == 119922 then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\"..DBM.Options.CountdownVoice.."\\shockwave.ogg")--震懾波
		sndWOP:Schedule(1.5, "Interface\\AddOns\\DBM-Sound-Yike\\yike\\shockwave.ogg")--震懾波
