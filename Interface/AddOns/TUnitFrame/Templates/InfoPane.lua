...
function InfoPaneClass.prototype:Create(infoType,parent,index)
	...
	self.UNIT_RAGE = self.UpdateUnitMana
	self.UNIT_ENERGY = self.UpdateUnitMana
	self.UNIT_FOCUS = self.UpdateUnitMana
	self.UNIT_RUNIC_POWER = self.UpdateUnitMana
	
	self.UNIT_MAXMANA = self.UpdateUnitMana
	self.UNIT_MAXENERGY = self.UpdateUnitMana
	self.UNIT_MAXHEALTH = self.UpdateUnitHealth
	self.UNIT_MAXRAGE = self.UpdateUnitMana
	self.UNIT_MAXFOCUS = self.UpdateUnitMana
	self.UNIT_MAXRUNIC_POWER = self.UpdateUnitMana
