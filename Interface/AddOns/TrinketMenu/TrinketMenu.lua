...
function TrinketMenu.SlashHandler(msg)
	...
	elseif string.find(msg,"load") then
				DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message12)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message13)
	else
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message6)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message7)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message8)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message9)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message10)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message11)
		DEFAULT_CHAT_FRAME:AddMessage(TrinketMenu.Message14)
	end
end
...
function TrinketMenu.TimersFrame_OnUpdate(self, elapsed)
	local timerPool
...
function TrinketMenu.MenuFrame_OnMouseDown(self, arg1)
	local arg1=GetMouseButtonClicked()
...
function TrinketMenu.MenuFrame_OnMouseUp(self, arg1)
	local arg1=GetMouseButtonClicked()
	if arg1=="LeftButton" then
...
function TrinketMenu.ReflectTrinketUse(slot)
	getglobal("TrinketMenu_Trinket"..(slot-13)):SetChecked(true)
	...
	elseif not CursorHasItem() and not SpellIsTargeting() then
		...
		if b then
			...
			if not isLocked and not IsInventoryItemLocked(slot) then
				...
				getglobal("TrinketMenu_Trinket"..(slot-13).."Icon"):SetDesaturated(true)
...
function TrinketMenu.RedRangeUpdate()
	...
	for i=13,14 do
		...
		if item and not IsItemInRange(item) then
